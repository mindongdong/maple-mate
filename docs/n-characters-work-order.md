...
> **✅ 구현 완료 (2026-06-15)** — PR #22 머지(`97792f6`). as-built·검증·구체화는 [n-characters-as-built.md](n-characters-as-built.md), 결정은 [ADR-0006](adr/0006-multi-character-data-model.md)·[ADR-0007](adr/0007-history-account-wide.md) 참조.
